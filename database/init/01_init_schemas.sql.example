...
INSERT INTO b2b.api_keys (company_id, access_key, key_name, daily_limit, is_active)
SELECT
    c.company_id,
...
WHERE c.manager_email = 'test@moviesir.cloud'
...
-- 기본 OTT 제공자 데이터
INSERT INTO public.ott_providers (provider_id, provider_name, logo_path, display_priority) VALUES
(8, 'Netflix', '/providers/netflix.png', 1),
...
(3, 'Google Play Movies', '/providers/googleplay.png', 6),
(1883, 'TVING', '/providers/tving.png', 7)
...
INSERT INTO public.users (email, password_hash, nickname, is_email_verified, onboarding_completed_at)
VALUES (
    'test@test.com',
    '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/X4.qJh1K1q1KSJQCC',
    '테스트유저',
