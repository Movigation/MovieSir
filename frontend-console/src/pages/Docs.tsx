  ...
  return (
    <button
      ...
      className={`absolute right-3 p-1.5 rounded-md transition-colors ${
        centered ? "top-1/2 -translate-y-1/2" : "top-2"
      } ${
        light
...
function CodeBlock({
  ...
  return (
    <div className="relative overflow-hidden bg-gray-900 border border-gray-200 group rounded-xl">
      {language && (
        <div className="px-4 py-2.5 border-b border-gray-800 flex items-center justify-between bg-gray-900">
          <span className="text-xs font-medium text-gray-500">{language}</span>
        </div>
      )}
      <pre
        className={`p-4 pr-12 overflow-x-auto ${showLineNumbers ? "pl-12" : ""}`}
      >
    ...
    <div className="flex items-center justify-between pt-8 mt-12 border-t border-gray-200">
      {prevItem ? (
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 text-gray-600 transition-colors rounded-lg hover:text-blue-600 hover:bg-gray-50 group"
        >
          <svg
          ...
          <div className="text-left">
            <span className="block text-xs text-gray-400">이전</span>
      ...
      {nextItem ? (
        ...
        >
          <div className="text-right">
            <span className="block text-xs text-gray-400">다음</span>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200">
        <div className="flex items-center justify-between h-16 px-6">
          ...
          <div className="flex items-center gap-3">
            <a
              href="https://api.moviesir.cloud"
              className="px-4 py-2 text-sm font-medium text-gray-600 transition-colors hover:text-blue-600"
            >
              API 홈
            </a>
            <Link
            ...
            <a
              ...
              className="px-4 py-2 text-sm font-medium text-white transition-colors bg-blue-600 rounded-lg hover:bg-blue-500"
            >
              콘솔로 이동
            </a>
          </div>
          ...
          <nav className="p-4">
            {categories.map((category) => (
              <div key={category} className="mb-6">
                <span className="px-3 text-xs font-semibold tracking-wider text-gray-400 uppercase">
                  {category}
                </span>
                    ...
                    .map((item) => (
                      <li key={item.id}>
                        ...
                        >
                          ...
                          <span
                            className={`truncate ${item.method ? "font-mono text-xs" : ""}`}
                          >
                            {item.label}
                          </span>
                        </button>
              ...
              <ul className="mt-2 space-y-1">
                <li>
                  <a
                    ...
                    className="flex items-center w-full gap-2 px-3 py-2 text-sm font-medium text-gray-600 transition-colors rounded-lg hover:bg-gray-100"
                  >
                    <svg
                      className="flex-shrink-0 w-4 h-4"
                      fill="none"
                ...
                <div className="prose prose-gray max-w-none">
                  <div id="intro-overview">
                    <p className="mb-4 text-lg leading-relaxed text-gray-600">
                      무비서 API는 AI 기반 영화 추천 기능을 <br />
                      여러분의 서비스에 손쉽게 연동할 수 있도록 제공하는 RESTful
                      API입니다.
                    </p>
                    <p className="mb-4 leading-relaxed text-gray-600">
                      SBERT(Sentence-BERT)와 LightGCN을 결합한 하이브리드 추천
                      알고리즘을 사용합니다.
                      <br />
                      콘텐츠 기반 추천과 협업 필터링의 장점을 모두 활용합니다.
                    </p>
                    <p className="mb-8 leading-relaxed text-gray-600">
                      단순한 장르 매칭을 넘어, 사용자의 취향과 시청 패턴을 심층
                      분석하여 최적의 영화를 추천합니다.
                    </p>
                  </div>

                  <div className="p-5 mb-8 border border-blue-200 bg-blue-50 rounded-xl">
                    ...
                    <ul className="space-y-3 text-blue-800">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          <strong>시간 맞춤 추천</strong>
                          <br />
                          <span className="text-sm text-blue-700">
                            이동 시간을 입력하면 해당 시간에 딱 맞는 영화 조합을
                            제안합니다.
                            <br />
                            3시간 비행이라면 2편의 영화 조합을, 5시간 KTX라면
                            3편을 추천합니다.
                          </span>
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          <strong>AI 개인화</strong>
                          <br />
                          <span className="text-sm text-blue-700">
                            사용자의 시청 이력과 평점 데이터를 분석하여 취향을
                            파악합니다.
                            <br />
                      ...
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          <strong>듀얼 트랙 추천</strong>
                          <br />
                          <span className="text-sm text-blue-700">
                            Track A는 선호 장르 중심, Track B는 새로운 장르
                            탐색용입니다.
                            <br />두 가지 추천 결과로 사용자에게 더 다양한
                            선택지를 제공하세요.
                          </span>
                        </span>
                      </li>
                  ...
                  <p className="mb-4 text-gray-600">
                    무비서는 두 가지 AI 모델을 결합한 하이브리드 추천 시스템을
                    사용합니다.
                  </p>
                  <div className="grid gap-4 mb-8 md:grid-cols-2">
                    <div className="p-6 border border-gray-200 rounded-xl">
                      ...
                      <p className="mb-3 text-sm text-gray-600 whitespace-nowrap">
                        Sentence-BERT 기반 <strong>콘텐츠 추천</strong>입니다.
                      </p>
                    ...
                    <table className="w-full text-sm">
                      <tbody>
                        <tr className="border-b border-gray-200">
                          <td className="w-40 px-4 py-3 font-medium text-gray-700 bg-gray-50">
                            Base URL
                          </td>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    {[
                      {
                        title: "여행/교통 앱",
                        desc: "비행기, KTX, 버스 이동 시간에 맞는 영화 추천",
                      },
                      {
                        title: "OTT 서비스",
                        desc: "구독 플랫폼에서 시청 가능한 콘텐츠만 필터링",
                      },
                      {
                        title: "숙박 플랫폼",
                        desc: "호텔 객실 내 엔터테인먼트 추천",
                      },
                      {
                        title: "피트니스 앱",
                        desc: "운동 시간에 맞는 콘텐츠 제안",
                      },
                    ].map((item, i) => (
                      <div
                        key={i}
                ...
                <div className="space-y-6">
                  {[
                    ...
                    },
                    {
                      ...
                      title: "OTT 필터링",
                      desc: "구독 중인 OTT 플랫폼을 지정하면 \n해당 플랫폼에서 바로 시청 가능한 영화만 추천합니다.\nNetflix, 티빙, Watcha, Disney+ 등을 지원합니다.",
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="mb-3 text-gray-600 whitespace-pre-line">
                            {feature.desc}
                          </p>
                  ...
                  {[
                    {
                      ...
                      action: {
                        label: "콘솔 바로가기",
                        link: "https://console.moviesir.cloud/login",
                      },
                    },
                    {
                      step: 2,
                    ...
                    <div key={i} className="flex gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="mb-3 text-gray-600 whitespace-pre-line">{item.desc}</p>
                        {item.code && (
                          <code className="block px-4 py-2 mb-3 text-sm text-gray-700 bg-gray-100 rounded-xl">
                            {item.code}
                          </code>
                        )}
                        {item.sdkCode && (
...
print(data)`}
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <button
                    ...
                    className="flex items-center gap-4 p-5 text-left transition-all border border-gray-200 rounded-xl hover:border-blue-200 hover:shadow-lg group"
                  >
                    <div className="flex items-center justify-center w-12 h-12 text-blue-600 transition-colors bg-blue-50 rounded-xl group-hover:bg-blue-100">
                      <svg
                        className="w-6 h-6"
                        fill="none"
                        stroke="currentColor"
            ...
            {activeSection === "auth" && (
              <div>
                <h1 className="mb-4 text-3xl font-bold text-gray-900">인증</h1>
                <p className="mb-4 leading-relaxed text-gray-600">
                  무비서 API는 API 키 기반 인증을 사용합니다.
                  <br />
                  모든 API 요청에는 유효한 API 키가 필요하며, 이 키는 요청의
                  출처를 식별하고 사용량을 추적하는 데 사용됩니다.
                </p>
                <p className="mb-8 leading-relaxed text-gray-600">
                  API 키는 콘솔에서 무료로 발급받을 수 있으며, 플랜에 따라 일일
                  호출 한도가 다릅니다.
                </p>
                ...
                <div className="space-y-10">
                  ...
                  <div id="auth-header">
                    ...
                    <p className="mb-4 text-gray-600">
                      모든 요청의 HTTP 헤더에{" "}
                      <code className="px-1.5 py-0.5 bg-gray-100 rounded text-sm font-medium">
                        X-API-Key
                      </code>
                      를 포함해야 합니다.
                      <br />
                      Bearer 토큰 방식이 아닌 커스텀 헤더를 사용하여 보다 명확한
                      인증 흐름을 제공합니다.
                    </p>
                    <div className="relative overflow-hidden bg-gray-900 rounded-xl">
                      <pre className="p-4 pr-12 font-mono text-sm text-gray-300">
                        <code>
                          <span className="text-gray-500">X-API-Key:</span>{" "}
                          <span className="text-sky-300">
                            sk-moviesir-xxxxxxxxxxxxxxxx
                          </span>
                        </code>
                      </pre>
                      <CopyButton text="X-API-Key: sk-moviesir-xxxxxxxxxxxxxxxx" centered />
                    </div>
                  </div>
                  ...
                  <div id="auth-format">
                    ...
                    <p className="mb-4 text-gray-600">
                      ...
                      로 시작하지 않는다면 잘못된 형식입니다.
                    </p>
                    <div className="overflow-hidden bg-white border border-gray-200 rounded-xl">
                      <table className="w-full">
                        <tbody className="divide-y divide-gray-200">
                          <tr>
                            <td className="w-32 px-4 py-3 text-sm font-medium text-gray-900 bg-gray-50">
                              접두사
                            </td>
                            <td className="px-4 py-3 text-sm text-gray-600">
                              <code className="px-2 py-0.5 bg-gray-100 rounded font-medium">
                                sk-moviesir-
                              </code>
                            </td>
                          </tr>
...
async def recommend(request_body: dict):
    ...
    return response.json()`}
                  ...
                  <div id="auth-env">
                    ...
                    <p className="mb-4 text-gray-600">
                      API 키는 코드에 직접 하드코딩하지 말고, 환경변수를 통해
                      관리하세요.
                      <br />
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="p-4 border border-gray-200 bg-gray-50 rounded-xl">
                        ...
                        <code className="block px-3 py-2 text-xs text-gray-300 bg-gray-900 rounded">
                  ...
                  <div
                    id="auth-security"
                    className="p-5 border bg-amber-50 border-amber-200 rounded-xl"
                  >
                      ...
                      <div>
                        ...
                        <ul className="space-y-2 text-sm text-amber-700">
                          <li className="flex gap-2">
                            ...
                            <span>
                              <strong>클라이언트 노출 금지</strong> - API 키를
                              프론트엔드 코드, 모바일 앱에 포함하지 마세요
                            </span>
                          </li>
                          <li className="flex gap-2">
                            <span className="text-amber-500">•</span>
                            <span>
                              <strong>서버 사이드 호출</strong> - 항상 백엔드
                              서버를 통해 API를 호출하세요
                            </span>
                          </li>
                          <li className="flex gap-2">
                            <span className="text-amber-500">•</span>
                            <span>
                              <strong>Git 커밋 주의</strong> - .env 파일을
                              .gitignore에 추가하세요
                            </span>
                          </li>
                          <li className="flex gap-2">
                            <span className="text-amber-500">•</span>
                            <span>
                              <strong>키 유출 시 대응</strong> - 즉시 콘솔에서
                              해당 키를 비활성화하고 새 키를 발급하세요
                            </span>
                          </li>
                        </ul>
                      </div>
                    ...
                    <div className="space-y-3">
                      <div className="p-4 bg-white border border-gray-200 rounded-xl">
                        <div className="flex items-center gap-3 mb-2">
                          <span className="px-2 py-0.5 bg-red-100 text-red-700 rounded text-xs font-mono font-medium">
                            401
                          </span>
                          <span className="font-medium text-gray-900">
                            INVALID_API_KEY
                        ...
                        <p className="text-sm text-gray-600">
                          API 키가 유효하지 않거나, 헤더에 포함되지 않은 경우
                        </p>
                        <p className="mt-1 text-xs text-gray-400">
                          → API 키가 정확한지, X-API-Key 헤더가 포함되었는지
                          확인
                        </p>
                      </div>
                      <div className="p-4 bg-white border border-gray-200 rounded-xl">
                      ...
                      <div className="p-4 bg-white border border-gray-200 rounded-xl">
                        ...
                        <p className="mt-1 text-xs text-gray-400">
                          → 다음 날 자정(UTC)에 한도가 초기화됨. 플랜 업그레이드
                          고려
                        </p>
                      </div>
                    </div>
                      ...
                      {[
                        {
                          step: 1,
                          title: "콘솔 로그인",
                          desc: "콘솔(console.moviesir.cloud)에서 계정으로 로그인합니다.\n계정이 없다면 무료로 가입할 수 있습니다.",
                        },
                        {
                          step: 2,
                          title: "API Keys 메뉴 이동",
                          desc: "좌측 사이드바에서 API Keys 메뉴를 클릭합니다.",
                        },
                        {
                          step: 3,
                          title: "새 키 발급",
                          desc: '키 이름을 입력하고 (예: "Production", "Development") "발급" 버튼을 클릭합니다.',
                        },
                        {
                          step: 4,
                          title: "키 안전하게 저장",
                          desc: "발급된 키를 복사하여 안전한 곳에 저장합니다.\n보안상 키는 발급 시에만 전체 내용을 확인할 수 있습니다.",
                        },
                      ].map((item) => (
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-700">
                          개발용과 프로덕션용 API 키를 분리하여 사용하면 사용량
                          추적과 보안 관리가 용이합니다.
                          <br />
                          문제 발생 시 특정 키만 비활성화할 수 있어 서비스
                          영향을 최소화할 수 있습니다.
                        </p>
                      </div>
                    </div>
            ...
            {activeSection === "recommend" && (
              <div>
                ...
                <p className="mb-8 leading-relaxed text-gray-600">
                  사용자의 선호도와 가용 시간을 기반으로 최적의 영화 조합을
                  추천합니다.
                </p>
                ...
                <div className="space-y-8">
                  ...
                  <div id="recommend-endpoint">
                    ...
                    <div className="relative p-4 bg-gray-900 rounded-xl">
                      ...
                      <CopyButton text="POST https://api.moviesir.cloud/v1/recommend" centered />
                    </div>
                    <Link
                      to="/playground"
                        ...
                        {activeTab === "request" ? (
                          ...
                          <pre className="overflow-x-auto leading-relaxed text-gray-300">
                            <code>
                              ...
                              <span className="text-amber-300">550</span>,{"\n"}
                              {"          "}
                              <span className="text-sky-300">
                                "title"
                              </span>:{" "}
                              ...
                              ,{"\n"}
                              {"          "}
                              <span className="text-sky-300">"poster_url"</span>
                              :{" "}
                              <span className="text-emerald-300">
                                "https://..."
                              </span>
                              ...
                              <span className="text-amber-300">139</span>,{"\n"}
                              {"          "}
                              <span className="text-sky-300">"genres"</span>: [
                              <span className="text-emerald-300">"드라마"</span>
                              ],{"\n"}
                              {"          "}
                              <span className="text-sky-300">
                                "score"
                              ...
                              {"          "}
                              <span className="text-sky-300">"id"</span>:{" "}
                              <span className="text-amber-300">27205</span>,
                              {"\n"}
                              {"          "}
                              <span className="text-sky-300">
                                "title"
                              </span>:{" "}
                              <span className="text-emerald-300">"인셉션"</span>
                              ,{"\n"}
                              {"          "}
                              <span className="text-sky-300">
                                "runtime"
                              ...
                              : <span className="text-amber-300">287</span>
                              {"\n"}
                              {"    "}
                              <span className="text-gray-500">{"}"}</span>,
                              {"\n"}
...

{
            ...
            {activeSection === "errors" && (
              <div>
                ...
                <p className="mb-2 leading-relaxed text-gray-600">
                  무비서 API는 표준 HTTP 상태 코드와 함께 상세한 에러 정보를
                  JSON 형식으로 반환합니다.
                </p>
                <p className="mb-8 leading-relaxed text-gray-600">
                  에러 코드를 활용하여 문제를 정확히 파악하고 적절한 에러
                  핸들링을 구현하세요.
                </p>
                ...
                <div className="space-y-10">
                  ...
                  <div id="errors-categories">
                    ...
                    <div className="grid gap-4 mb-6 md:grid-cols-3">
                      <div className="p-4 border bg-amber-50 rounded-xl border-amber-200">
                        <div className="flex items-center gap-2 mb-2">
                          <span className="px-2 py-0.5 bg-amber-100 text-amber-700 rounded text-xs font-mono font-medium">
                            4xx
                          </span>
                      ...
                      <div className="p-4 border border-orange-200 bg-orange-50 rounded-xl">
                        ...
                        <p className="text-sm text-orange-700">
                          호출 한도 초과입니다. 시간을 두고 재시도하세요.
                        </p>
                      </div>
                      <div className="p-4 border border-gray-200 bg-gray-50 rounded-xl">
                        <div className="flex items-center gap-2 mb-2">
                          <span className="px-2 py-0.5 bg-gray-200 text-gray-700 rounded text-xs font-mono font-medium">
                            5xx
                          </span>
                        ...
                        <tbody className="divide-y divide-gray-200">
                          {[
                            ...
                            },
                            {
                              ...
                              desc: "파라미터 값 오류",
                              solution: "runtime_limit, genres 등 값 범위 확인",
                              color: "amber",
                            },
                            {
                              status: "401",
                  ...
                  <div id="errors-format">
                    ...
                    <p className="mb-4 text-gray-600">
                      ...
                      <code className="px-1.5 py-0.5 bg-gray-100 rounded text-sm mx-1">
                        success
                      </code>
                      는 항상
                      <code className="px-1.5 py-0.5 bg-gray-100 rounded text-sm mx-1">
                    ...
                    <div className="relative overflow-hidden bg-gray-900 rounded-xl">
                      ...
                      <pre className="p-4 pr-12 overflow-x-auto font-mono text-sm leading-relaxed text-gray-300">
                        <code>
                          <span className="text-gray-500">{"{"}</span>
                          {"\n"}
                          {"  "}
    ...
    return null;
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <ul className="space-y-1 text-sm text-blue-700">
                          ...
                          <li>
                            • 5xx 에러는 지수 백오프(exponential backoff)로
                            재시도하세요
                          </li>
            ...
            {activeSection === "rate-limit" && (
              <div>
                ...
                <p className="mb-2 leading-relaxed text-gray-600">
                  무비서 API는 안정적인 서비스 제공을 위해 일일 호출 한도를
                  적용합니다.
                </p>
                <p className="mb-8 leading-relaxed text-gray-600">
                  한도는 플랜에 따라 다르며, 매일 자정(UTC 00:00)에
                  초기화됩니다.
                </p>
                  ...
                  <div id="rate-how-it-works">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="p-4 bg-white border border-gray-200 rounded-xl">
                        ...
                        <p className="text-sm text-gray-600">
                          매일 자정 UTC (한국시간 오전 9시)에 카운터가 0으로
                          초기화됩니다.
                        </p>
                      </div>
                      <div className="p-4 bg-white border border-gray-200 rounded-xl">
                      ...
                      <div className="p-4 bg-white border border-gray-200 rounded-xl">
                        ...
                        <p className="text-sm text-gray-600">
                          Rate Limit은 API 키 단위로 적용됩니다.
                          <br />
                          여러 키를 사용하면 각각 별도로 카운팅됩니다.
                        </p>
                      </div>
                      <div className="p-4 bg-white border border-gray-200 rounded-xl">
                        <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="mt-4">
                      ...
                      <div className="p-4 bg-gray-900 rounded-xl">
                        <code className="font-mono text-sm leading-relaxed text-gray-300">
                          ...
                          <span className="text-emerald-300">1000</span>
                          {"\n"}
                          <span className="text-gray-500">
                            X-RateLimit-Remaining:
                          </span>{" "}
                          <span className="text-emerald-300">742</span>
                          {"\n"}
                          <span className="text-gray-500">
                            X-RateLimit-Reset:
                          </span>{" "}
                          <span className="text-emerald-300">1704844800</span>
                        </code>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative overflow-hidden bg-gray-900 rounded-xl">
                      ...
                      <pre className="p-4 pr-12 overflow-x-auto font-mono text-sm leading-relaxed text-gray-300">
                        <code>
                          ...
                          ,{"\n"}
                          {"    "}
                          <span className="text-sky-300">"limit"</span>:{" "}
                          <span className="text-emerald-300">1000</span>,{"\n"}
                          {"    "}
                          <span className="text-sky-300">"reset_at"</span>:{" "}
                          <span className="text-amber-300">
  ...
  return response.json();
                      ...
                      <div>
                        ...
                        <ul className="space-y-2 text-sm text-blue-700">
                          <li className="flex gap-2">
                            ...
                            <span>
                              <strong>응답 캐싱</strong> - 동일한 파라미터에
                              대한 응답을 캐싱하여 불필요한 호출 감소
                            </span>
                          </li>
                          <li className="flex gap-2">
                            <span className="text-blue-500">•</span>
                            <span>
                              <strong>배치 처리</strong> - 가능한 경우 요청을
                              묶어서 처리하여 호출 횟수 절약
                            </span>
                          </li>
                          <li className="flex gap-2">
                            <span className="text-blue-500">•</span>
                            <span>
                              <strong>헤더 모니터링</strong> -
                              X-RateLimit-Remaining 헤더를 주시하고 임계치 도달
                              시 알림 설정
                            </span>
                          </li>
                          <li className="flex gap-2">
                            <span className="text-blue-500">•</span>
                            <span>
                              <strong>지수 백오프</strong> - 429 에러 발생 시
                              점진적으로 대기 시간을 늘려 재시도
                            </span>
                          </li>
                          <li className="flex gap-2">
                            <span className="text-blue-500">•</span>
                            <span>
                              <strong>플랜 업그레이드</strong> - 지속적으로
                              한도에 도달한다면 플랜 업그레이드를 검토하세요
                            </span>
                          </li>
                        </ul>
                      </div>
                  ...
                  {/* Warning */}
                  <div className="p-5 border bg-amber-50 border-amber-200 rounded-xl">
                    <div className="flex gap-3">
                      <svg
                        className="w-5 h-5 text-amber-600 flex-shrink-0 mt-0.5"
                        fill="none"
                      ...
                      <div>
                        ...
                        <p className="text-sm text-amber-700">
                          Rate Limit을 우회하기 위해 여러 API 키를 사용하거나
                          계정을 생성하는 행위는 이용약관 위반입니다.
                          <br />
                          지속적으로 높은 트래픽이 필요한 경우 Enterprise 플랜을
                          문의해주세요.
                        </p>
                      </div>
                    </div>
                ...
                <div className="space-y-8">
                  ...
                  <div id="single-endpoint">
                    ...
                    <div className="relative p-4 bg-gray-900 rounded-xl">
                      ...
                      <CopyButton text="POST https://api.moviesir.cloud/v1/recommend_single" centered />
                    </div>
                    <Link
                      to="/playground"
                      className="inline-flex items-center gap-1.5 mt-3 text-sm text-blue-600 hover:text-blue-500 font-medium"
              ...
              <ul className="mt-3 space-y-2">
                {currentToc.map((item) => (
                  <li key={item.id}>
                    <a
                      href={`#${item.id}`}
                      className="block py-1 text-sm text-gray-600 transition-colors hover:text-blue-600"
                    >
                      {item.label}
                    </a>
                  </li>
