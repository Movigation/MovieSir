...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { data } = await api.post('/b2b/auth/register', {
        name: form.name,
        email: form.email,
      ...
      <main className="relative flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-[400px]">
          ...
          <div className="bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 shadow-2xl overflow-hidden">
            ...
            <div className="p-6">
              ...
              <div className="space-y-3 mb-6">
                <GoogleLoginButton onClick={handleGoogleLogin} text="Google로 시작하기" />
                <GitHubLoginButton onClick={handleGitHubLogin} text="GitHub로 시작하기" />
              </div>
              ...
              <div className="relative mb-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-transparent text-white/50">또는 이메일로 가입</span>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <p className="mt-4 text-xs text-white/40 text-center leading-relaxed">
                  가입 시{' '}
                  <a href="#" className="text-blue-400 hover:text-blue-300 hover:underline">이용약관</a>
                  {' '}및{' '}
                  <a href="#" className="text-blue-400 hover:text-blue-300 hover:underline">개인정보처리방침</a>
                  에 동의합니다
                </p>
              </form>
            </div>
          ...
          <div className="mt-6 flex items-center justify-center gap-3 text-sm">
            <span className="text-white/50">이미 계정이 있으신가요?</span>
