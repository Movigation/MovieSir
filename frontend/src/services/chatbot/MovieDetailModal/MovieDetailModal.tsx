    ...
    <Modal isOpen={!!detailMovieId} onClose={handleClose}>
      ...
      {movieDetail && !isLoading && (
        <div>
          ...
          {/* 모바일: OTT 플랫폼 (전체 너비) */}
          {movieDetail.ott_providers &&
            movieDetail.ott_providers.length > 0 && (
                    ...
                    movieDetail.ott_providers.length > 0 && (
                      <div className="mt-2">
                        ...
                        <div className="flex flex-wrap gap-3">
                          {Array.from(
                            new Map(
                              movieDetail.ott_providers.map(
                                (ott: OTTPlatform) => [ott.ott_id, ott]
                              )
                            ).values()
                          ).map((ott: OTTPlatform) => (
                            <a
              ...
              <div className="flex gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                >
                  <Heart
                    size={20}
                    fill={
                      movieDetail!.user_status?.liked ? "currentColor" : "none"
                    }
                  />
                  좋아요
                </button>
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-lg font-medium transition-colors ${
                    movieDetail!.user_status?.bookmarked
                ...
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-lg font-medium transition-colors ${
                    movieDetail!.user_status?.watched
