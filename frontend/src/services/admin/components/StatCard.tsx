    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
            <div className="flex items-center justify-between mb-3 sm:mb-4">
                ...
                <div className="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 bg-gray-100 dark:bg-gray-700 rounded-lg">
                    {icon}
                </div>
            </div>
            ...
            {trend && (
                <div className="flex items-center gap-1">
                    <span className={`text-xs sm:text-sm font-medium ${trendUp
                        ? "text-green-500"
                        : "text-red-500"
                        }`}>
                        {trendUp ? "↑" : "↓"} {trend}
