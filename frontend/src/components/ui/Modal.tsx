    ...
    return createPortal(
        ...
        >
            ...
            >
                <button
                    onClick={onClose}
                    className="absolute top-4 right-4 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-white z-50 bg-white/80 dark:bg-gray-800/80 rounded-full p-1 backdrop-blur-sm focus:ring-2 focus:ring-blue-500 outline-none"
                    aria-label="모달 닫기"
                >
                    <X size={24} />
                </button>
